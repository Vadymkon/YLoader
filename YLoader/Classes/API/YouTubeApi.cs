...
{
    //YouTube Staff
    public class YouTubeApi : VideoApp
    {
        public List<PlaylistItem> own_videos = new List<PlaylistItem>();
        YouTubeService service, youtubeService, service3;
        ...
        public async void UpdateVideoInfo(VideoFile vFile)
        {
        ...
        {
            throw new Exception("YouTube API not allowed to upload videos."); // here is nothing, bcs we're don't allow this function
        }
        /*
